...
void gfxt_init(int w_chars, int h_chars, const char* (*prompt_fn)(void), int (*eval_fn)(const char*), void (*scroll_push_fn)(const char*, int), const char* (*scroll_prev_fn)(int), void (*history_push_fn)(const char*), const char* (*history_prev_fn)(int));
